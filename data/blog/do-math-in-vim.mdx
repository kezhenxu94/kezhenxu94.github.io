...
summary: |
  In this post, you will learn how to use the expression register to evaluate a mathematical expresion and insert the result in vim,
  you will also learn how to use expression register in combination with other registers to evaluate a long expression
tags: [ vim, tools, tips ]
date: 2024-11-25
draft: false
---
