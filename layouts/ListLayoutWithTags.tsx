    ...
    <>
      <div>
        ...
        <div className="flex sm:space-x-5">
          <div className="hidden h-full max-h-screen min-w-[280px] max-w-[280px] flex-wrap overflow-auto rounded bg-gray-50 pt-5 dark:bg-gray-900/70 dark:shadow-gray-800/40 sm:flex">
